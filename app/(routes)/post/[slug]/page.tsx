...
import { RichTextComponent } from "../../blog/components/RichTextComponent";
...
// - ISR
// revalidate this page every 20 seconds
...
async function PostPage({ params: { slug } }: Props) {
  ...
  return (
    post && (
      <article className="px-10 pb-28 mt-32">
        <Link href={"/blog"}>
          <ArrowLeft className=" mb-5 h-8 w-8" />
        </Link>
